				...
				<div className="row">
					...
					<div className="col-12">
						<div className="quadre">
							Aquesta comanda conté articles amb
							disponiblitat immediata i d’altres que
							poden trigar uns dies abans de ser enviats.
							Vols rebre'ls junts? o pefereixes que
							t’enviem ja els llibres disponibles i et fem un
