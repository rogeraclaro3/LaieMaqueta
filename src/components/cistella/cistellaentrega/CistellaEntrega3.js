				...
				<div className="row">
					...
					<div className="col-12 separab15">
						<div className="quadre">
							<br />
							Botiga seleccionada:
							<div className="interior-botiga">
								<span className="text-entrega">Laie CCCB</span><br />
								De dilluns a diumenge i festius de 10.30 a 20.30 h.<br /><br />

								Carrer de Montalegre 5<br />
								08001 Barcelona, Espanya<br />
								Google maps<br /><br />

								93 481 38 86<br />
								<a href="mailto:laiecccb@laie.es">laiecccb@laie.es</a>
							</div>
							<div className="d-flex">
								<div className="p-0 mr-auto"></div>
								<div className="p-4"><Link to="/cistella5"><Button className="btn-buit">CANVIAR DE BOTIGA</Button></Link></div>
							</div>
						</div>
					</div>
